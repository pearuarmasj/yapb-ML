...
// DQN AI system function declarations
extern void initializeNeuralZombieAI();
extern void shutdownNeuralZombieAI();
...
void Game::levelInitialize (edict_t *entities, int max) {
   ...
   // Initialize DQN AI System
   initializeNeuralZombieAI();
